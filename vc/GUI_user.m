...
prompt = {'Enter QP value'};
title = 'QP Value';
definput = {'5'};
opts.Interpreter = 'tex';
QP = inputdlg(prompt,title,[1 40],definput,opts);
videoCompression(QP{1,1});
writeVideo();
videoSrc = vision.VideoFileReader('SampleVideo_640x360_1mb.mp4', 'ImageColorSpace', 'RGB');

videoSrc_dec = vision.VideoFileReader('/Users/macbookair/Desktop/Multimedia Systems/Ass2/vc/results/decoded.avi', 'ImageColorSpace', 'RGB');
